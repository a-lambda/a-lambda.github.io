...
![Configuration du projet de site Web Quarto](01_create-quarto-website.PNG){#fig-config_projet_quarto}
...
## Modification du répertoire 'output' du site Web 
...
![Modification du répertoire output](02_output-dir-modification.PNG){#fig-output_dir} 
...
![Configuration pour site web personnel](03_create-personal-website.PNG){#fig-website} 

![Configuration pour un site projet](04_create-project-site.PNG){#fig-site_projet}
...
![Configuration de déploiement du site](05_repository-settings-pages.PNG){#fig-configuration_pages} 
